...
import com.example.yin.service.impl.CourseServiceImpl;
import com.example.yin.utils.initLogRecord;
...
public class YinMusicApplicationTests {
    ...
    @Test
    public void test01() {
        CollectService course = new CollectServiceImpl();
        System.out.println(course.collectionOfUser(1));
    }
